...
public class rentSportswear {
    public static void main(String[] args) {
        ...
        removeStudent(getLostNumber, getReserveNumber);

        allNumber = allNumber - count(getLostNumber, getReserveNumber);
    ...
    private static void removeStudent(ArrayList<Integer> getLostNumber, ArrayList<Integer> getReserveNumber) {
    ...
    private static int count(ArrayList<Integer> getLostNumber, ArrayList<Integer> getReserveNumber) {
        for (int i = 0; i < getLostNumber.size(); i++) {
            for (int j = 0; j < getReserveNumber.size(); j++) {
